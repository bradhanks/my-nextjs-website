import { image } from '../../../../studio-project/image'
import { getPostsForFeed } from '../../../../studio-project/queries'
...
export async function GET(req: Request) {
  ...
  interface Post {
    ...
    excerpt?: string;
    publishedAt?: string;
    mainImage?: any; // Using any since we don't know the exact type expected by image()
    author?: Author;
  }
